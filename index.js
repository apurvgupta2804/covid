  ...
  (async () => {
    ...
    try {
      ...
      const { data: slotDetails } = await axios.get(
        `https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/calendarByDistrict?district_id=770&date=21-05-2021`
      );
      ...
      if (isSlotAvailable) {
        console.log("Apurv Gupta :  available")
        ...
        // Open page.
        await page.goto(
          `https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/calendarByPin?pincode=380019&date=21-05-2021`
        );
